...
const TABS: TabConfig[] = [
  { label: "Beranda", icon: "home-outline", activeIcon: "home" },
  { label: "Belajar", icon: "book-outline", activeIcon: "book" },
  { label: "Guru AI", icon: "sparkles-outline", activeIcon: "sparkles" },
  { label: "Chat", icon: "chatbubble-outline", activeIcon: "chatbubbles" },
